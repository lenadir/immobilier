...
return [
    ...
    'description' => 'API REST complète pour la gestion d\'agences immobilières. Authentification via Laravel Sanctum (Bearer token). Rôles disponibles : admin, agent, guest.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtenez votre token via <b>POST /api/auth/login</b>, puis envoyez-le dans l\'en-tête : <code>Authorization: Bearer {token}</code>.',
    ],
